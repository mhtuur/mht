...

    {
        protected override void Seed(DataContext context)
        {
            ...
            var products = new List<Product>()
            {
                ...
                new Product(){Name="THERMALTAKE VERSA A47 650W 3x120mm FANLI ATX OYUNCU KASASI" , Description="Profesyonel PC" , Price=125 ,IsApproved=true,Stock=22,CategoryId=2,Image="2.jpg"},
                new Product(){Name="Casper" , Description="Profesyonel PC" , Price=4500 ,IsApproved=false,Stock=32,CategoryId=2,Image="2.jpg"},
                new Product(){Name="Lenovo" , Description="Profesyonel PC" , Price=8000 ,IsApproved=true,Stock=0,CategoryId=2,IsHome=true,Image="2.jpg"},
